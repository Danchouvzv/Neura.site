  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-[100] flex justify-center px-4 pointer-events-none">
      <nav className={`pointer-events-auto transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] flex items-center justify-between gap-4 md:gap-12 px-5 md:px-8 ${
        scrolled 
          ? 'py-2.5 bg-black/70 backdrop-blur-3xl border border-[#ff007f33] rounded-full shadow-[0_25px_50px_-12px_rgba(0,0,0,0.7),0_0_20px_rgba(255,0,127,0.15)] w-full max-w-4xl' 
        ...
        <Link to="/" className="flex items-center gap-3 group cursor-pointer shrink-0">
          <div className="relative">
            ...
            <div className="relative w-9 h-9 md:w-11 md:h-11 bg-[#ff007f] rounded-xl flex items-center justify-center font-tech font-black text-black text-lg md:text-xl shadow-[0_0_20px_rgba(255,0,127,0.3)] group-hover:scale-105 group-hover:rotate-[10deg] transition-all duration-500">
              N
            </div>
          </div>
          <div className="flex flex-col hidden sm:flex">
            <span className="font-tech text-lg md:text-xl font-black tracking-tighter text-white leading-none">NEURA</span>
            <span className="text-[7px] font-black text-[#ff007f] tracking-[0.3em] uppercase opacity-80">COM_HUB</span>
          </div>
        </Link>
