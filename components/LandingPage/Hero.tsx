      ...
      >
        ...
        <div className="relative space-y-6 sm:space-y-8 md:space-y-12 max-w-5xl z-10 py-6 sm:py-8 md:py-10">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 md:gap-8 pt-4 sm:pt-6 px-4">
            <Link 
              to="#products" 
              className="group relative px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 bg-[#ff007f] text-black font-black uppercase tracking-[0.15em] sm:tracking-[0.2em] text-[9px] sm:text-[10px] md:text-xs rounded-xl sm:rounded-2xl transition-all hover:scale-105 hover:shadow-[0_0_50px_rgba(255,0,127,0.5)] active:scale-95 text-center min-h-[44px] flex items-center justify-center"
            >
              <span className="relative z-10">Connect Now</span>
            </Link>
            <Link 
              to="#mission" 
              className="group px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 bg-transparent border-2 border-[#ff007f]/40 text-white font-black uppercase tracking-[0.15em] sm:tracking-[0.2em] text-[9px] sm:text-[10px] md:text-xs rounded-xl sm:rounded-2xl hover:bg-[#ff007f11] hover:border-[#ff007f] transition-all flex items-center justify-center gap-2 sm:gap-3 min-h-[44px]"
            >
              Learn More
